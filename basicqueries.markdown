...
The [Coghent Random Image Viewer](https://cogent-random-image.herokuapp.com/), for example, makes use of above query. The code can be found [here](https://github.com/CoGhent/random_image_viewer)
